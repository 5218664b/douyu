...
APP_BASE_IMAGE="${APP_BASE_IMAGE:-douyu-app-base:pi4b}"
APP_IMAGE="${APP_IMAGE:-douyu-app:pi4b}"
APP_BASE_TAR_NAME="${APP_BASE_TAR_NAME:-douyu-app-base-pi4b.tar}"
APP_TAR_NAME="${APP_TAR_NAME:-douyu-app-pi4b.tar}"
